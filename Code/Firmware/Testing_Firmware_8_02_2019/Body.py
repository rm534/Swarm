...
class SwarmBody():
    ...
    def __init__(self, motor_pin1='P10', motor_pin2='P11', motor_pin3='P12', motor_pin4='P6',SDA='P7', SCL='P22', lidar_DIO1='P2', lidar_DIO2='P3', lidar_DIO3='P4', lidar_DIO4='P5'):
        self.initialise_I2C(SDA, SCL)
        # self.initialise_motor(motor_pin1, motor_pin2, motor_pin3, motor_pin4)
        # self.initialise_gyro()
        self.initialise_lidar( lidar_DIO1, lidar_DIO2, lidar_DIO3, lidar_DIO4)
    ...
    def initialise_lidar(self, lidar_DIO1, lidar_DIO2, lidar_DIO3, lidar_DIO4):
